...
class SQLServer implements DatabaseAdapter {
    ...
    public function connect(): void {
        ...
        $this->pdo->exec("IF NOT EXISTS (SELECT * FROM sys.tables WHERE name='messages') CREATE TABLE messages (id INT IDENTITY(1,1) PRIMARY KEY, sender NVARCHAR(255) NOT NULL DEFAULT '', subject NVARCHAR(255) NOT NULL, body NVARCHAR(MAX) DEFAULT '', read INT DEFAULT 0, created_at DATETIME DEFAULT GETDATE())");
    }
