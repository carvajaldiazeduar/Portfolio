...
class PostgreSQL implements DatabaseAdapter {
    ...
    public function connect(): void {
        ...
        $this->pdo->exec("CREATE TABLE IF NOT EXISTS messages (id SERIAL PRIMARY KEY, sender TEXT NOT NULL DEFAULT '', subject TEXT NOT NULL, body TEXT DEFAULT '', read INTEGER DEFAULT 0, created_at TIMESTAMP DEFAULT NOW())");
    }
