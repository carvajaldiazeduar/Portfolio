...
module DatabaseUrl
  ...
  def build
    ...
    name = ENV.fetch("DB_NAME", "inboxes")
    ...
    case driver
    when "sqlite"
      file.empty? ? "sqlite3:db/inboxes.sqlite3" : "sqlite3:#{file}"
    when "mysql"
...
module InboxesApp
  class Application < Rails::Application
    ...
    config.secret_key_base = ENV.fetch("SECRET_KEY_BASE", "inboxes-development-secret-key")
