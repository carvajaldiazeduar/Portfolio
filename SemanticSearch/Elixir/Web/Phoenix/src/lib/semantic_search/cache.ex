defmodule SemanticSearch.Cache do
  @moduledoc """
  ...
  defp adapter do
    case Application.get_env(:semantic_search, :cache_type, "local") do
      "redis" -> SemanticSearch.Cache.RedisCache
      _ -> SemanticSearch.Cache.LocalCache
    end
  end
end
