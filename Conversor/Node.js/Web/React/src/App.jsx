...
function App() {
  ...
  return (
    <div className="conversor">
      ...
      <div className="form">
        <select value={category} onChange={(e) => { setCategory(e.target.value); setFromUnit(categories[e.target.value].units[0]); setToUnit(categories[e.target.value].units[1] || categories[e.target.value].units[0]); setResult(null) }}>
