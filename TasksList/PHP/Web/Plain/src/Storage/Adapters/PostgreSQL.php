...
class PostgreSQL implements DatabaseAdapter {
    ...
    public function connect(): void {
        ...
        $this->pdo->exec("CREATE TABLE IF NOT EXISTS tasks (id SERIAL PRIMARY KEY, title TEXT NOT NULL, description TEXT DEFAULT '', completed INTEGER DEFAULT 0, created_at TIMESTAMP DEFAULT NOW())");
    }
