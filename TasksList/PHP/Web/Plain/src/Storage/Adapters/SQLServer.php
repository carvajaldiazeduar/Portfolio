...
class SQLServer implements DatabaseAdapter {
    ...
    public function connect(): void {
        ...
        $this->pdo->exec("IF NOT EXISTS (SELECT * FROM sys.tables WHERE name='tasks') CREATE TABLE tasks (id INT IDENTITY(1,1) PRIMARY KEY, title NVARCHAR(255) NOT NULL, description NVARCHAR(MAX) DEFAULT '', completed INT DEFAULT 0, created_at DATETIME DEFAULT GETDATE())");
    }
