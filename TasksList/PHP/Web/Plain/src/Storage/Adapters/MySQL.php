...
class MySQL implements DatabaseAdapter {
    ...
    public function connect(): void {
        ...
        $this->pdo->exec("CREATE TABLE IF NOT EXISTS tasks (id INT AUTO_INCREMENT PRIMARY KEY, title TEXT NOT NULL, description TEXT DEFAULT '', completed INT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)");
    }
