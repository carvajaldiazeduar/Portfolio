...
name = System.get_env("DB_NAME", "tasks_list")
...
config :tasks_list, TasksList.Repo, Keyword.put(repo_opts, :pool_size, String.to_integer(pool_size))

if System.get_env("PHX_SERVER") do
  config :tasks_list, TasksListWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :tasks_list, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
