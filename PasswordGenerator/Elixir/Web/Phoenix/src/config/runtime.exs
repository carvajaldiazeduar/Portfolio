...
name = System.get_env("DB_NAME", "password_generator")
...
config :password_generator, PasswordGenerator.Repo, Keyword.put(repo_opts, :pool_size, String.to_integer(pool_size))

if System.get_env("PHX_SERVER") do
  config :password_generator, PasswordGeneratorWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :password_generator, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
