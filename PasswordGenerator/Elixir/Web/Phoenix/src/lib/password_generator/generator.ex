defmodule PasswordGenerator.Generator do
  @moduledoc """
  Secure, configurable password generation.

  Mirrors the Java `PasswordGenerator` behaviour:
  ...
  @doc "Generates a random password with the given options. Returns {:ok, pw} or {:error, msg}."
