...
module DatabaseUrl
  ...
  def build
    ...
    name = ENV.fetch("DB_NAME", "password_generator")
    ...
    case driver
    when "sqlite"
      file.empty? ? "sqlite3:db/password_generator.sqlite3" : "sqlite3:#{file}"
    when "mysql"
...
module PasswordGeneratorApp
  class Application < Rails::Application
    ...
    config.secret_key_base = ENV.fetch("SECRET_KEY_BASE", "passwordgenerator-development-secret-key")
