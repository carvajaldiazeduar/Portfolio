...
class SQLServer(DatabaseAdapter):
    ...
    def connect(self):
        ...
        self.conn = pymssql.connect(
            ...
            database=os.getenv("DB_NAME", "passwords"),
    ...
    def get_all(self, table):
        return self._query(f"SELECT TOP 50 * FROM {table} ORDER BY id DESC", fetchall=True)
    ...
    def create(self, table, data):
        ...
        self._execute(f"INSERT INTO {table} ({cols}) VALUES ({placeholders})", values)
        return None
