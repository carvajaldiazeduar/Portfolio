...
class PostgreSQL implements DatabaseAdapter {
    ...
    public function connect(): void {
        ...
        $this->pdo->exec("CREATE TABLE IF NOT EXISTS password_entries (id SERIAL PRIMARY KEY, password TEXT NOT NULL, length INTEGER DEFAULT 16, created_at TIMESTAMP DEFAULT NOW())");
    }
