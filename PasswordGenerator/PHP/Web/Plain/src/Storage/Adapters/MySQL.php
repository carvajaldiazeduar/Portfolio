...
class MySQL implements DatabaseAdapter {
    ...
    public function connect(): void {
        ...
        $this->pdo->exec("CREATE TABLE IF NOT EXISTS password_entries (id INT AUTO_INCREMENT PRIMARY KEY, password TEXT NOT NULL, length INT DEFAULT 16, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)");
    }
