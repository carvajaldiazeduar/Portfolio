    ...
    <div className="container">
      ...
      <div className="form">
        <div className="form-group">
          ...
          <input id="name" className={fieldClass('name')} value={name} onChange={(e) => setName(e.target.value)} placeholder="Enter name" />
          {attempted && errors.name && <span className="field-error">{errors.name}</span>}
        </div>
        <div className="form-group">
          <label htmlFor="phone">Phone</label>
          <input id="phone" className={fieldClass('phone')} value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Enter phone" />
          {attempted && errors.phone && <span className="field-error">{errors.phone}</span>}
        </div>
        <div className="form-group">
          <label htmlFor="email">Email</label>
          <input id="email" className={fieldClass('email')} value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter email" />
