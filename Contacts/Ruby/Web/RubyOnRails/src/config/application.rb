...
module DatabaseUrl
  ...
  def build
    ...
    name = ENV.fetch("DB_NAME", "contacts")
    ...
    case driver
    when "sqlite"
      file.empty? ? "sqlite3:db/contacts.sqlite3" : "sqlite3:#{file}"
    when "mysql"
...
module ContactsApp
  class Application < Rails::Application
    ...
    config.secret_key_base = ENV.fetch("SECRET_KEY_BASE", "contacts-development-secret-key")
