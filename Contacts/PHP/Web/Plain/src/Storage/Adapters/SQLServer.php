...
class SQLServer implements DatabaseAdapter {
    ...
    public function connect(): void {
        ...
        $this->pdo->exec("IF NOT EXISTS (SELECT * FROM sys.tables WHERE name='contacts') CREATE TABLE contacts (id INT IDENTITY(1,1) PRIMARY KEY, name NVARCHAR(255) NOT NULL, phone NVARCHAR(255) DEFAULT '', email NVARCHAR(255) DEFAULT '')");
    }
