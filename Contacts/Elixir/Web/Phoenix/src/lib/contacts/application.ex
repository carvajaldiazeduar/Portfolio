defmodule Contacts.Application do
  ...
  def start(_type, _args) do
      ...
      [
        ...
        Contacts.Cache.LocalCache
      ] ++
        if(Application.get_env(:contacts, :cache_type, "local") == "redis", do: [
          {Contacts.Cache.RedisCache,
           host: Application.get_env(:contacts, :redis_host, "localhost:6379")}
        ], else: []) ++
        [
