...
config :contacts, :cache_type, System.get_env("CACHE_TYPE", "local")
config :contacts, :redis_host, System.get_env("REDIS_HOST", "localhost:6379")
config :contacts, :cache_ttl, String.to_integer(System.get_env("CACHE_TTL", "300"))
